using UnityEngine;
using UnityEngine.InputSystem; // 新しい Input System に対応
...
namespace Otai5
{
    ...
    /// （SE再生機能付き）
    /// </summary>
    public class CornerCameraController2 : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (Keyboard.current != null)
            {
                ...
                {
                    Debug.Log("[CornerCameraController] Qキーが押されました -> 左回転");
                    RotateCamera(-1);
                }
                // Eキーで右に90度回転
                if (Keyboard.current.eKey.wasPressedThisFrame)
                {
                    Debug.Log("[CornerCameraController] Eキーが押されました -> 右回転");
                    RotateCamera(1);
                }
            }
        }
        ...
        /// <summary>
        /// 方向を指定して90度回転（角の45度/135度/225度/315度）
        /// </summary>
